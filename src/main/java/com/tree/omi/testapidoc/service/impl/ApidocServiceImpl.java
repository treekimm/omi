package com.tree.omi.testapidoc.service.impl;
...
import com.tree.omi.common.filter.TestControllerFilter;
import com.tree.omi.common.filter.TestDtoFilter;
...
public class ApidocServiceImpl implements ApidocService {
	...
	public List<String> getApiName() throws Exception {
		...
		TestControllerFilter exceptNotControllerFilter = new TestControllerFilter(); // 커스텀 필터 인스턴스 생성 -> 컨트롤러 클래스만 읽어오게끔 필터링 TypeFilter의 구현체
	...
	public List<String> getDtoName() throws Exception {
		...
		TestDtoFilter includeNotDtoFilter = new TestDtoFilter();
